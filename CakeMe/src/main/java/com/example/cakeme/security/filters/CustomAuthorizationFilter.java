package com.example.cakeme.security.filters;
// Rimuovi o commenta l'import di tools.jackson
// import tools.jackson.databind.ObjectMapper;

// ATTIVA l'importazione standard di com.fasterxml.jackson
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // 🟢 MODIFICA QUESTA RIGA: Lascia passare subito sia il login sia le GET sulle torte
        if (request.getServletPath().equals("/api/login") ||
                request.getServletPath().equals("/api/greet") ||
                request.getServletPath().startsWith("/api/ai") ||
                request.getServletPath().contains("/api/cakes/shop")||
                (request.getServletPath().startsWith("/api/cakes") && request.getMethod().equals("GET")) ||
                request.getServletPath().equals("/api/cakes/shop-name")  ||
                (request.getServletPath().startsWith("/api/shops") && request.getMethod().equals("GET"))) {
