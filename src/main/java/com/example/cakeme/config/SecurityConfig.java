    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        // 🟢 AGGIUNGI QUESTA RIGA: Permette a chiunque di vedere le torte senza token!
                        ...
                        .anyRequest().authenticated()); // Tutte le altre rotte (comprese POST/PUT/DELETE di torte) rimangono protette
